...
TS,P=192,12
for f in [f"/home/user/-/reference/{n}.jpg" for n in ("01_front_full","02_front_jacket","03_back_full")]:
    name=os.path.basename(f)[:-4]; o=T+"upfull/"+name+".png"
    if os.path.exists(o): continue
    im=Image.open(f).convert("RGB"); w,h=im.size; C=48
    a=np.asarray(im.crop((24,6,w-24,h-8))); Image.fromarray(a).save(T+"lofull/"+name+".png")
